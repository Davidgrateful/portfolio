      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div>
            ...
            <FadeIn delay={0.2}>
              <p className="text-sec/70 max-w-md font-medium">
                Explore my decentralized applications and smart contracts.
              </p>
            </FadeIn>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <FadeIn delay={0.4}>
              <MagneticButton>
                <Link to="/web3-works" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wider hover:text-sec/60 transition-colors group">
                  All Projects
