...
export default function CrissCrossMarquee() {
  ...
  return (
    <section className="relative h-64 bg-main overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="absolute w-[200%] bg-sec text-main py-4 transform -rotate-3 z-10 flex whitespace-nowrap overflow-hidden shadow-xl">
        <motion.div 
          animate={{ x: ["-50%", "0%"] }}
      ...
      <div className="absolute w-[200%] bg-main text-sec border-y-2 border-sec py-4 transform rotate-3 flex whitespace-nowrap overflow-hidden">
        <motion.div 
          animate={{ x: ["0%", "-50%"] }}
          transition={{ repeat: Infinity, ease: "linear", duration: 30 }}
          className="flex whitespace-nowrap text-2xl md:text-4xl font-bold uppercase tracking-wider"
